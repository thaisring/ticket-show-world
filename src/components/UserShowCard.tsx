  ...
  return (
    <div className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow">
      <div className="relative">
        ...
        />
        <div className="absolute top-2 right-2 bg-[#f84464] text-white px-2 py-1 rounded text-sm font-medium">
          ₹{show.ticket_price}
        </div>
      </div>
      ...
      <div className="p-4">
        ...
        <div className="text-sm text-gray-600 mb-2">
          <p className="font-medium">{show.genre}</p>
          <p>{show.venue}</p>
        </div>
        ...
        <button
          ...
          className="w-full bg-[#f84464] hover:bg-[#d83454] text-white py-2 px-4 rounded font-medium transition-colors"
        >
          View Details
        </button>
      </div>
