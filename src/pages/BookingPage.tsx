            ...
            <div>
              <div className="bg-gray-50 rounded-lg p-6 mb-6">
                <div className="flex gap-4">
                  ...
                  />
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">{displayData.title}</h3>
                    <p className="text-gray-600">{isUserShow ? show?.genre : event?.genre}</p>
                    {isUserShow && show && (
                      <>
                        <p className="text-gray-600">{formatDate(show.show_date)}</p>
                        <p className="text-gray-600">{formatTime(show.show_time)} • {show.venue}</p>
                      </>
                    )}
                  </div>
                </div>
              ...
              {!isUserShow && event?.showtimes && (
                <div className="mb-6">
                  <h4 className="text-lg font-semibold text-gray-900 mb-3">Select Showtime</h4>
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">{showtime.venue}</p>
                          </div>
                        </div>
              ...
              {/* Ticket Quantity */}
              <div className="mb-6">
                <h4 className="text-lg font-semibold text-gray-900 mb-3">Number of Tickets</h4>
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-gray-600 ml-4">₹{ticketPrice} each</span>
                </div>
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#f84464]"
              ...
              <div className="bg-gray-50 rounded-lg p-6 sticky top-8">
                ...
                <div className="space-y-3">
                  <Button
                    ...
                    className="w-full bg-[#f84464] hover:bg-[#d83454] text-white py-3 text-lg font-semibold"
                  >
                    Proceed to Payment
                  </Button>
